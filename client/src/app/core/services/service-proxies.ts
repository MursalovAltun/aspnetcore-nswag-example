...
export class ProductsService {
    ...
    get(id: string | undefined): Observable<Product> {
        let url_ = this.baseUrl + "/api/Products/Get?";
        if (id === null)
    ...
    add(id: string | undefined, name: string | null | undefined, price: number | undefined): Observable<Product> {
        let url_ = this.baseUrl + "/api/Products/Add?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
    ...
    update(id: string | undefined, name: string | null | undefined, price: number | undefined): Observable<Product> {
